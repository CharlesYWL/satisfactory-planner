  ...
  zh: {
    translation: {
      ...
      output: {
        ...
        targetsTitle: '目标产品',
        targetsHint: '可添加多个目标产品共享同一条产线：共用的中间产物会合并为同一节点，机器数与原矿需求跨目标累加。',
        addTarget: '添加目标',
        removeTarget: '移除目标',
      ...
      graph: {
        ...
        blueprintLanes: '并行产线',
        blueprintLanesNote: '整条产线复制成 {{count}} 条并行线，每条一条满档带（≤{{speed}}/min）；机器已均分到各条。',
        totalPower: '总功耗',
      ...
      logistics: {
        ...
        manifoldNote: 'manifold 沿途抽料，靠背压自平衡（非按比例分流；总供给=总需求时稳态成立）',
      },
    },
  },
  en: {
    translation: {
      ...
      output: {
        ...
        targetsTitle: 'Target products',
        targetsHint:
          'Add multiple targets that share one production line: shared intermediates merge into a single node, and machine counts / raw needs add up across targets.',
      ...
      graph: {
        ...
        blueprintLanes: 'Parallel lines',
        blueprintLanesNote:
          'Whole line replicated into {{count}} parallel copies, each on one full belt (≤{{speed}}/min); machines split evenly across them.',
      ...
      logistics: {
        ...
        manifoldNote:
          'Manifold overflow tap — self-balances via back-pressure (not proportional; holds in steady state when supply = demand)',
      },
    },
  },
} as const;
